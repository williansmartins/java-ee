...
public class DAODespesa {
	...
	public List<Despesa> getDespesas() {
		...
		despesas.add(new Despesa("Combustível", CategoriaDespesa.VEICULO, LocalDate.now(), 80, "3"));
		despesas.add(new Despesa("Tênis", CategoriaDespesa.VESTUARIO, LocalDate.now(), 237, "4"));
		despesas.add(new Despesa("Almoço", CategoriaDespesa.ALIMENTACAO, LocalDate.now(), 30, "5"));
		despesas.add(new Despesa("Conte de Energia", CategoriaDespesa.MORADIA, LocalDate.now(), 170, "6"));
		despesas.add(new Despesa("Pagamento Pós", CategoriaDespesa.EDUCACAO, LocalDate.now(), 850, "7"));
		despesas.add(new Despesa("Plano de Saúde", CategoriaDespesa.SAUDE, LocalDate.now(), 360, "8"));
